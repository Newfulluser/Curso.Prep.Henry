...
function promedioResultadosTest(resultadosTest) {
  ...
  for (let index = 0; index < resultadosTest.length; index++) {
    ...
    sumaResult = sumaResult + resultadosTest[index];
  }
  return sumaResult / resultadosTest.length
}
